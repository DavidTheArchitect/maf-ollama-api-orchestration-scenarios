"""Scenario 17: group chat over the A2A protocol for the Invocations API sample.
...
locally with::
    ...
    python -m invocations_scenarios.a2a_servers.partner_agents --port 8765

Run the scenario directly with::

    python -m invocations_scenarios.scenarios.group_chat_partner_launch_review
"""
...
SCENARIO = ScenarioSpec(
    ...
    sample_task=(
        "Run a joint launch review job for the co-sold analytics integration (window 2026-07-15 to "
        "2026-07-31). Partner-side integration status and external compliance status are owned by "
        "partner organizations -- their agents must speak for those facts."
    ),
