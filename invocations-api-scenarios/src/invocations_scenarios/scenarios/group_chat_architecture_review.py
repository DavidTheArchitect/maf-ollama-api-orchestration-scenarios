"""Group chat architecture review board job scenario (MCP tools) for the Invocations API sample."""
...
SCENARIO = ScenarioSpec(
    ...
    pattern="group-chat",
    title="Group Chat Architecture Review Job",
    ...
    when_to_use="Use Invocations plus group chat orchestration when a decision job needs documented debate across engineering, security, finance, and delivery before a chair commits to an answer.",
    sample_task="Run an architecture review board job for ADR-2209 (customer notification service, build versus buy) and return a decision with conditions and an exit strategy.",
