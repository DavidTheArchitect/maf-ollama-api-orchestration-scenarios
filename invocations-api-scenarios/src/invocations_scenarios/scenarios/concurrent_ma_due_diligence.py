"""Concurrent M&A due diligence job scenario (MCP tools) for the Invocations API sample."""
...
SCENARIO = ScenarioSpec(
    ...
    pattern="concurrent",
    title="Concurrent M&A Due Diligence Job",
    ...
    when_to_use="Use Invocations plus concurrent orchestration for deal jobs where independent expert lanes can run at the same time and the recommendation is only as good as the slowest workstream you would otherwise wait on.",
    sample_task="Run a due diligence job for acquisition target TARGET-ACQ-STELLAR across finance, legal, technology, and market lanes and return a deal recommendation.",
