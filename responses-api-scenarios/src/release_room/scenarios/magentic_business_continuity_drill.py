"""Magentic business continuity drill scenario (MCP tools) for the Responses API sample."""
...
SCENARIO = ScenarioSpec(
    ...
    pattern="magentic",
    title="Magentic Business Continuity Drill",
    learning_goal="Learn how a magentic manager plans and delegates a continuity drill, with specialists pulling facts from local MCP tools as the plan evolves.",
    when_to_use="Use Responses plus magentic orchestration for open-ended planning where a manager must dynamically delegate continuity-drill work across facilities, IT, communications, finance, and operations.",
    sample_input="Plan and delegate a business continuity drill for FACILITY-DC-EAST (overdue tier-1 site) across facilities, IT, communications, finance, and operations.",
    agents=(
        AgentSpec(
