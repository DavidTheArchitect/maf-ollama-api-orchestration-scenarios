"""Scenario 16 quote-to-cash (Concurrent) for the Responses API sample.

Run directly with::

    python -m release_room.scenarios.scenario_16_quote_to_cash_concurrent
"""
...
SCENARIO = ScenarioSpec(
    ...
    learning_goal="Learn how the same quote request can be enriched by instruction-led specialists in parallel, then aggregated into one quote context.",
