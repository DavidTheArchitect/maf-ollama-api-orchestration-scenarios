"""Handoff transaction dispute routing scenario (MCP tools) for the Responses API sample."""
...
SCENARIO = ScenarioSpec(
    ...
    pattern="handoff",
    title="Handoff Transaction Dispute Routing",
    ...
    when_to_use="Use Responses plus handoff orchestration for dispute requests where fraud, merchant-error, and subscription cases need different owners and a wrong route has real regulatory cost.",
    sample_input="Route transaction dispute DISPUTE-90455 (duplicate charge with a lost-card report) to the owning specialist and return the resolution and customer communication.",
