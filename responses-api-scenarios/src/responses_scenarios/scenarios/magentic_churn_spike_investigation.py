"""Magentic churn spike investigation scenario (MCP tools) for the Responses API sample."""
...
SCENARIO = ScenarioSpec(
    ...
    pattern="magentic",
    title="Magentic Churn Spike Investigation",
    ...
    when_to_use="Use Responses plus magentic orchestration for investigation requests where which specialists matter — and in what order — only becomes clear as evidence arrives.",
    sample_input="Investigate the Q3 churn spike METRIC-CHURN-Q3 concentrated in SEGMENT-ENT-EU, identify the dominant driver, and return a remediation plan.",
    agents=(
        AgentSpec(
