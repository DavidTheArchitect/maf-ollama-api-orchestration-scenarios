...
(see :mod:`responses_scenarios.executors`) with agent nodes wrapped in
...
async def run_scenario_sample(
    ...
    **config_overrides: Any,
    ...
    workflow = build_responses_workflow(scenario.id, max_tokens=tokens, **config_overrides)
